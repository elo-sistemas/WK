...
uses
  ...
  model.pedido.produto in '..\admin\pedido_produto\model\model.pedido.produto.pas',
  dao.pedido.produto in '..\admin\pedido_produto\dao\dao.pedido.produto.pas',
  controllers.pedido.produto in '..\admin\pedido_produto\controller\controllers.pedido.produto.pas',
  Form.View.Pesquisa.Produto in '..\admin\pedido\view\Form.View.Pesquisa.Produto.pas' {FormViewPesquisaProduto};
