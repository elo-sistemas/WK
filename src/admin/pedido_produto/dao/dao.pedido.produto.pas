...
begin
  ...
  try
    try
      ...
      aQRY.Close;
      aQRY.sql.Clear;
      aQRY.SQL.Add('INSERT INTO pedido_produto(codigo_ped, codigo_prod, quantidade, valor_unitario, valor_total) ');
...
begin
  ...
  try
    try
      aQRY.Close;
      aQRY.sql.Clear;
      aQRY.SQL.Add('select pp.codigo, pp.codigo_ped, pp.codigo_prod, p.descricao, pp.quantidade, pp.valor_unitario, pp.valor_total ');
      ...
      begin
        ...
        begin
          aQRY.SQL.Add('WHERE pp.codigo_ped =:codigo_ped ');
          aQRY.Params.ParamByName('codigo_ped').AsInteger := aPesquisa.ToInteger;
        end;
