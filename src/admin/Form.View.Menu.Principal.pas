...
procedure TFormViewMenuPrincipal.actPedidoExecute(Sender: TObject);

var
  LForm: TFormViewPedidoCad;
begin
  Application.CreateForm(TFormViewPedidoCad, LForm);
  ShowForm(TFormViewPedidoCad, LForm);
